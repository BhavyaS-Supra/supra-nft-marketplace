...
export function ConnectWallet() {
  ...
  // Wallet presence can only be known on the client. useSyncExternalStore reports `false` for
  // the server-rendered snapshot and the real value on the client, avoiding a hydration mismatch
  // without routing the read through an effect + setState.
  const hasStarKey = useSyncExternalStore(
    () => () => {},
